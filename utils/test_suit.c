...
void test_threads()
{
  ...
  request_list_node *request = create_request(NULL, NULL, 255, 10, 0, 0, Read);
  add_request_in_list(&request_manager, request);

  request_list_node *request2 = create_request(NULL, NULL, 254, 11, 0, 0, Read);
  add_request_in_list(&request_manager, request2);

  request_list_node *request3 = create_request(NULL, NULL, 253, 12, 0, 0, Read);
